...
namespace sltl
{
  ...
  {
    return typename sltl::detail::function_traits<Fn>::return_t::proxy(syntax::expression::make<syntax::function_call>(syntax::function_manager_guard()->emplace(fn), detail::get_args(std::forward<T>(t)...)));
  }
}
